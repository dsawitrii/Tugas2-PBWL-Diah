...
<head>
	...
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/Photo Diah Sawitri.jpg" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/Photo Diah Sawitri.jpg" class="brand">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/golongan">
						<img class="icon" src="<?php echo AST; ?>/img/energy-class.png" alt=""> Data Golongan
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/add-friend.png" alt=""> Data Pelanggan
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright&copy; 2023 by Diah Sawitri
		</footer>
	</main>
